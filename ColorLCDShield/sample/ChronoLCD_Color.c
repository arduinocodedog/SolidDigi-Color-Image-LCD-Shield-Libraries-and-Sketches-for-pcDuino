...
void displayDigitalTime(int h, int m, int s, int ap)
{
  ...
  /* No you idiot don't add blank spaces, you need to NULL-terminate the string!!!!!
     and oh-by-the-way ... you needed to make the array larger too ... should have been 13 for your way!!!! 
     kept crashing arduino so the clock reset ... wasn't working worth a crap!!!! */
  timeChar[11] = NULL;
...
void loop()
{
  ...
  seconds+=2;  // PC DUINO is so slow, we need to increment by 2
  if (seconds >= 60)
  {
